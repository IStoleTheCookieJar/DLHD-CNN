...
'''
This script is used for 1x3 panel plots.

It will be hard-coded for obslimit plots for HI, X-ray, and
HI+Xray.

Added accuracy.py file for statistics.
'''
...
def create_subplot(fig, field_type, train, test, i, n_subplot):
    ...
    ax = fig.add_subplot(1, 3, n_subplot)
    for j in range(len(params_true_[indexes,i])):
        ...
        if n_subplot == 1:
            ...
            if i == 0:
                ...
                ax.axes.text(11.5, 14.25, r'$\rm{Observational\ Limits}$', fontsize=16)
                ax.axes.text(11.5, 14, r'\rm{X–ray}', fontsize=16)
            if i == 1:
                ax.set_ylabel(r'$\log(M_{\rm{cgm, infer}})$', fontsize=18)
                ax.set_xlabel(r'$\log(M_{\rm{cgm, truth}})$', fontsize=18)
                ax.set_xlim(9.5, 12.5)
                ax.set_ylim(9.5,12.5)
                ax.axes.text(9.75, 12.25, r'$\rm{Observational\ Limits}$', fontsize=16)
                ax.axes.text(9.75, 12, r'\rm{X–ray}', fontsize=16)
            if i == 2:
                ax.set_ylabel(r'$f_{\rm{cool, infer}}$', fontsize=18)
                ax.set_xlabel(r'$f_{\rm{cool, truth}}$', fontsize=18)
            if i == 3:
                ax.set_ylabel(r'$\log(T_{\rm{cgm, infer}})$', fontsize=18)
                ax.set_xlabel(r'$\log(T_{\rm{cgm, infer}})$', fontsize=18)
            if i == 4:
                ax.set_ylabel(r'$\log(Z_{\rm{cgm, infer}})$', fontsize=18)
                ax.set_xlabel(r'$\log(Z_{\rm{cgm, truth}})$', fontsize=18)
            #ax.axes.text(-3.5, -1.5, r'$\rm{Xray}$', fontsize=16)
            if i == 5:
                ax.set_ylabel(r'$f_{\rm{cgm, infer}}$', fontsize=18)
                ax.set_xlabel(r'$f_{\rm{cgm, truth}}$', fontsize=18)
            #ax.axes.text(0, 0.22, r'$\rm{Xray}$', fontsize=16)
            div = axgrid.make_axes_locatable(ax)
            dummydata = ax.scatter([minimum[i],maximum[i]], [minimum[i],maximum[i]], c=[minimum[0],maximum[0]], cmap='viridis',s=0.001)
            cax = div.append_axes("right", size="5%", pad=0.0, zorder=20)
            cb = fig.colorbar(dummydata,cax=cax)
            cb.set_ticks([])
        elif n_subplot == 2:
            if i == 0:
                #ax.set_ylabel(r'$M_{\rm{halo, infer}}$', fontsize=18)
                ax.set_xlabel(r'$\log(M_{\rm{halo, truth}})$', fontsize=18)
                ax.axes.text(11.5, 14.25, r'$\rm{Observational\ Limits}$', fontsize=16)
                ax.axes.text(11.5, 14, r'\rm{HI}', fontsize=16)
            if i == 1:
                #ax.set_ylabel(r'$M_{\rm{CGM, infer}}$', fontsize=18)
                ax.set_xlabel(r'$\log(M_{\rm{cgm, truth}})$', fontsize=18)
                ax.set_xlim(9.5, 12.5)
                ax.set_ylim(9.5,12.5)
                ax.axes.text(9.75, 12.25, r'$\rm{Observational\ Limits}$', fontsize=16)
                ax.axes.text(9.75, 12, r'\rm{HI}', fontsize=16)
            if i == 2:
                #ax.set_ylabel(r'$f_{\rm{cool, infer}}$', fontsize=18)
                ax.set_xlabel(r'$f_{\rm{cool, truth}}$', fontsize=18)
            if i == 3:
                #ax.set_ylabel(r'$\log(T_{\rm{infer}})$', fontsize=18)
                ax.set_xlabel(r'$\log(T_{\rm{cgm, infer}})$', fontsize=18)
            if i == 4:
                #ax.set_ylabel(r'$\log(Z_{\rm{infer}})$', fontsize=18)
                ax.set_xlabel(r'$\log(Z_{\rm{cgm, truth}})$', fontsize=18)
            #ax.axes.text(-3.5, -1.5, r'$\rm{Xray}$', fontsize=16)
            if i == 5:
                #ax.set_ylabel(r'$f_{\rm{cgm, infer}}$', fontsize=18)
            ...
            div = axgrid.make_axes_locatable(ax)
            dummydata = ax.scatter([minimum[i],maximum[i]], [minimum[i],maximum[i]], c=[minimum[0],maximum[0]], cmap='magma',s=0.001)
            cax = div.append_axes("right", size="5%", pad=0.0, zorder=20)
            cb = fig.colorbar(dummydata,cax=cax)
            cb.set_ticks([])
        elif n_subplot == 3:
            if i == 0:
                ...
                ax.set_xlabel(r'$\log(M_{\rm{halo, truth}})$', fontsize=18)
                ax.axes.text(11.5, 14.25, r'$\rm{Observational\ Limits}$', fontsize=16)
                ax.axes.text(11.5, 14, r'$\rm{HI+X–ray}$', fontsize=16)
            if i == 1:
                #ax.set_ylabel(r'$M_{\rm{CGM, infer}}$', fontsize=18)
                ax.set_xlabel(r'$\log(M_{\rm{cgm, truth}})$', fontsize=18)
                ax.set_xlim(9.5, 12.5)
                ax.set_ylim(9.5,12.5)
                ax.axes.text(9.75, 12.25, r'$\rm{Observational\ Limits}$', fontsize=16)
                ax.axes.text(9.75, 12, r'\rm{HI+X–ray}', fontsize=16)
            if i == 2:
                #ax.set_ylabel(r'$f_{\rm{cool, infer}}$', fontsize=18)
                ax.set_xlabel(r'$f_{\rm{cool, truth}}$', fontsize=18)
            if i == 3:
            ...
            ax.yaxis.set_tick_params(labelleft=False)
            div = axgrid.make_axes_locatable(ax)
            dummydata = ax.scatter([minimum[i],maximum[i]], [minimum[i],maximum[i]], c=[minimum[0],maximum[0]], cmap='plasma',s=0.001)
            cax = div.append_axes("right", size="5%", pad=0.0, zorder=20)
            cb = fig.colorbar(dummydata,cax=cax)
        ...
        '''
            ...
            if i == 0:
                ax.set_ylabel(r'$M_{\rm{halo, infer}}$', fontsize=18)
                ax.set_xlabel(r'$M_{\rm{halo, truth}}$', fontsize=18)
                ax.axes.text(11.5, 14.25, r'$\rm{HI}$', fontsize=16)
            if i == 4:
                ax.set_ylabel(r'$\log(Z_{\rm{infer}})$', fontsize=18)
                ax.set_xlabel(r'$\log(Z_{\rm{truth}})$', fontsize=18)
                ax.axes.text(-3.5, -1.5, r'$\rm{HI}$', fontsize=16)
            if i == 5:
                ax.set_ylabel(r'$f_{\rm{cgm, infer}}$', fontsize=18)
                ax.set_xlabel(r'$f_{\rm{cgm, truth}}$', fontsize=18)
                ax.axes.text(0, 0.22, r'$\rm{HI}$', fontsize=16)
        elif n_subplot == 5:
            #ax.set_yticks([])
            ax.yaxis.set_tick_params(labelleft=False)
            if i == 0:
            ...
            cax = div.append_axes("right", size="5%", pad=-0.1, zorder=20)
            cb = fig.colorbar(dummydata,cax=cax)
            cb.ax.tick_params(labelsize=15) # was 12
            cb.ax.set_ylabel(r'$\log(M_{halo}/M_{\odot})$',labelpad=16,fontsize=18) # was 14
        '''
...
ax2 = create_subplot(fig, 'HI', sims[0], sims[0], i, 2)
ax3 = create_subplot(fig, 'HI_XraySoft', sims[0], sims[0], i, 3)
...
print('Label:', label)
fig.savefig('/home/ng474/CMD_py/panel_cut_testing_1x3_%s%s_cbs.png'%(label,obs_limit), bbox_inches='tight', pad_inches=0.25)
