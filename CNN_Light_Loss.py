...
test_loader = build_loader(clid_test, shuffle=True)
all_loader = build_loader(ids_new, shuffle = True)
...
def objective(trial):
    ...
    train_loader = build_loader(clid_train_mini, shuffle=True)
    valid_loader = build_loader(clid_valid, shuffle=True)
...
# TODO
    ...
    for i in range(N_epochs): # testing the model every 50 epochs of the pretraining model
